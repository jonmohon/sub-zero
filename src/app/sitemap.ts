...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    { url: `${BASE_URL}/services/refrigerator-repair/`, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${BASE_URL}/services/freezer-repair/`, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${BASE_URL}/services/icemaker-repair/`, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${BASE_URL}/services/wine-cooler-repair/`, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${BASE_URL}/services/sub-zero-marine-repair/`, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${BASE_URL}/areas-we-service/`, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${BASE_URL}/brands-we-service/`, changeFrequency: "monthly" as const, priority: 0.7 },
    { url: `${BASE_URL}/sub-zero-appliance-repair-in-south-florida/`, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${BASE_URL}/bosch-appliance-repair-in-south-florida/`, changeFrequency: "monthly" as const, priority: 0.7 },
    { url: `${BASE_URL}/viking-appliance-repair-in-south-florida/`, changeFrequency: "monthly" as const, priority: 0.7 },
    { url: `${BASE_URL}/thermador-appliance-repair-in-south-florida/`, changeFrequency: "monthly" as const, priority: 0.7 },
    { url: `${BASE_URL}/expert-miele-appliance-repair-in-south-florida/`, changeFrequency: "monthly" as const, priority: 0.7 },
