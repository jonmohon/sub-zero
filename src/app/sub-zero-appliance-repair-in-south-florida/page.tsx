  ...
  return (
    <>
      ...
      <AnswerBlock
        ...
        answer="Sub-Zero Repair Services has serviced Sub-Zero refrigerators, freezers, ice makers, wine columns, and marine units across South Florida since 1994. Our team works exclusively on premium built-in refrigeration — every Sub-Zero line from current Designer and Pro 48 to legacy 532, 632, and 690 series. Same-day appointments across Miami-Dade, Broward, Palm Beach, and four more counties. OEM parts on every truck."
        stats={[
