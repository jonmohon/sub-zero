...
export const metadata: Metadata = {
  title: { absolute: "Thank You | Sub-Zero Repair Services" },
  description:
    ...
    <section className="py-24">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-12">
          ...
          <h1 className="text-3xl font-bold text-[#0B1D33] mb-4">
            Thank You!
          </h1>
          ...
          <p className="text-[#64748B] mb-8">
            ...
            <a
              ...
              className="text-[#00B4D8] hover:text-[#0B1D33] font-semibold"
            >
              (800) 651-4528
            </a>
            .
