      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-xl py-20 lg:py-28">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link
              href="/contact"
              className="group inline-flex items-center justify-center bg-[#f89406] hover:bg-[#e08505] text-white px-8 py-4 rounded-lg font-semibold text-base transition-all duration-300 hover:shadow-[0_0_30px_rgba(201,165,78,0.3)] hover:-translate-y-0.5 tracking-wide"
            >
            ...
            <Link
              href="/services"
              className="inline-flex items-center justify-center border border-white/20 text-white/80 hover:text-white hover:border-white/40 px-8 py-4 rounded-lg font-semibold text-base transition-all duration-300 tracking-wide"
            >
              View Services
            </Link>
          </div>
          ...
          {/* Divider */}
          <div className="mt-8 w-full max-w-sm border-t border-white/10" />
