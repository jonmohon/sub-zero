        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <ScrollReveal animation="fade-up" delay={100}>
            <div className="group relative bg-white/80 backdrop-blur-xl rounded-2xl p-10 shadow-xl border border-white/20 hover:-translate-y-1 hover:shadow-2xl transition-all duration-500 h-full">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#0B1D33] mb-4 leading-tight">
                Sub-Zero Appliance Repair in Coral Gables, FL — Headquartered Locally Since 1994
              </h2>
              <p className="text-[#64748B] leading-relaxed mb-8 text-base">
                Headquartered in Coral Gables on Ponce De Leon Boulevard, we&apos;ve focused on Sub-Zero, Wolf, and Cove repair exclusively for three decades. No general appliance work distracts from the specialty — which is why our diagnostic time on a Sub-Zero call is measured in minutes, not hours.
              </p>
              <Link
          ...
          <ScrollReveal animation="fade-up" delay={250}>
            <div className="group relative bg-white/80 backdrop-blur-xl rounded-2xl p-10 shadow-xl border border-white/20 hover:-translate-y-1 hover:shadow-2xl transition-all duration-500 h-full">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#0B1D33] mb-4 leading-tight">
                Five Service Lines, From Built-In Refrigeration to Marine Units
              </h2>
              <p className="text-[#64748B] leading-relaxed mb-8 text-base">
                Refrigerators, freezers, ice makers, wine columns, and marine refrigeration on yachts docked across South Florida — every Sub-Zero product line we cover, our technicians have worked for years. OEM parts ride on every truck, so most calls finish in a single visit.
              </p>
              <Link
                href="/services"
                className="inline-flex items-center gap-2 text-[#00B4D8] font-semibold group/link hover:gap-3 transition-all duration-300"
