              ...
              {reviews.map((review, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-semibold text-[#0B1D33]">{review.name}</p>
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs font-bold text-[#0B1D33]">{review.rating}</span>
                      </div>
                    </div>
                  </div>
                );
              ...
              <ScrollReveal key={feature.title} animation="fade-up" delay={index * 150}>
                ...
                >
                  ...
                  <div className="relative flex items-start gap-5">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-[#0B1D33] mb-2">{feature.title}</h3>
