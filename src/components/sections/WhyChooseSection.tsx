...
export default function WhyChooseSection() {
  ...
  const floatClasses = ["animate-float", "animate-float-delay-1", "animate-float-delay-2"];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal animation="fade-up">
          <div className="mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#0387cc] leading-tight">
            ...
            <div className="relative">
              ...
              {reviews.map((review, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-10 h-10 bg-[#0387cc] rounded-full flex items-center justify-center text-white text-xs font-bold shadow-lg">
                      {review.name.charAt(0)}
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-[#0387cc]">{review.name}</p>
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs font-bold text-[#0387cc]">{review.rating}</span>
                      </div>
                    </div>
                  </div>
                );
              ...
              <ScrollReveal key={feature.title} animation="fade-up" delay={index * 150}>
                ...
                >
                  ...
                  <div className="relative flex items-start gap-5">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-[#0387cc] mb-2">{feature.title}</h3>
