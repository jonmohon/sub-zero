          ...
          <div className="relative overflow-hidden rounded-2xl text-white py-16 px-8 text-center" style={{ background: 'radial-gradient(ellipse at center, #1a3a5c 0%, #0F3460 40%, #0A2540 100%)' }}>
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center bg-[#f89406] hover:bg-[#e08505] text-white px-10 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105"
