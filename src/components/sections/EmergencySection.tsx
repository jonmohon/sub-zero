    ...
    <section className="relative py-24 overflow-hidden" style={{ background: "linear-gradient(to bottom, #ffffff, #F8FAFC)" }}>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h3 className="text-[#f89406] font-semibold uppercase tracking-[0.2em] mb-3 text-sm">Emergency Services</h3>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center bg-[#f89406] hover:bg-[#e08505] text-white px-10 py-4.5 rounded-xl font-bold text-lg transition-all duration-300 shadow-[0_0_30px_rgba(248,148,6,0.25)] hover:shadow-[0_0_40px_rgba(248,148,6,0.35)] hover:-translate-y-0.5"
            >
