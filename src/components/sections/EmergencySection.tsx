        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <ScrollReveal animation="fade-up">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0B1D33] mb-6 leading-tight text-shimmer">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              {guarantees.map((item, index) => (
                <ScrollReveal key={item} animation="fade-up" delay={index * 80}>
                  <div
                    className="group bg-white rounded-2xl p-5 shadow-sm border border-gray-100 card-hover"
                  >
