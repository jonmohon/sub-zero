  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h3 className="text-[#00B4D8] font-semibold uppercase tracking-[0.2em] mb-3 text-center text-sm">
          Our Services
        </h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {servicesList.map((service) => (
            <Link
              key={service.title}
              href={service.href}
              className="group relative rounded-2xl overflow-hidden shadow-2xl shadow-black/30 hover:shadow-[0_20px_60px_rgba(0,180,216,0.2)] hover:-translate-y-2 transition-all duration-500 ease-out"
            >
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-2xl shadow-black/20 border-l-4 border-[#00B4D8]">
          <div className="grid lg:grid-cols-2">
            <div className="p-8 lg:p-12">
              ...
              <Link
                href="/services/refrigerator-repair"
                className="inline-flex items-center gap-2 bg-[#0A2540] hover:bg-[#0F3460] text-white px-8 py-3.5 rounded-xl font-semibold text-sm transition-all duration-300 hover:shadow-lg hover:shadow-[#0A2540]/30 hover:-translate-y-0.5"
              >
                Learn More
