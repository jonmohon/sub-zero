...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#0a1e3d] to-[#152232] text-gray-300">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              <a
                ...
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors"
              >
            ...
            <div className="border-t border-white/20 pt-4">
              <address className="not-italic space-y-2 text-sm">
                <p className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#0099CC] shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
                  </svg>
                  Miami, FL 33131
                </p>
                <p className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#0099CC] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <a href="tel:+18006514528" className="hover:text-white transition-colors">
                    +1 (800) 651-4528
                  </a>
                </p>
                <p className="flex items-center gap-2">
                  ...
                  <a href="mailto:info@fivestarappliancerepairpros.com" className="hover:text-white transition-colors">
